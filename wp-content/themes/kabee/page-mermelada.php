<?php get_header(); ?>
   ...
   <div class="headermsmermelada">

      <div class="contmensajemermelada col-xs-push-1 col-xs-10 col-sm-push-3 col-sm-6   col-md-push-3 col-lg-push-3 col-md-6 col-lg-6 ">

        <div class="mensajeproductos col-md-12 col-lg-12">

          <h5 class="titulomensaje">MERMELADA</h5>
   ...
   <div class="contenedorpro">
    ...
    $loop_mermelada = new WP_Query($args);
    if( $loop_mermelada->have_posts() ):
      while( $loop_mermelada->have_posts() ): $loop_mermelada->the_post(); ?>
...
<?php    endwhile; endif;
global $wp_query;
$wp_query = $loop_mermelada ;
if (function_exists( 'wp_pagenavi' )) {
  //wp_pagenavi( array( 'query' => $loop_mermelada ) );
}

<?php get_header(); ?>
   ...
   <div class="headermsspa">

      <div class="contmensajespa col-xs-push-1 col-xs-10 col-sm-push-3 col-sm-6   col-md-push-3 col-lg-push-3 col-md-6 col-lg-6 ">

        <div class="mensajeproductos col-md-12 col-lg-12">

          <h5 class="titulomensaje">SPA</h5>
   ...
   <div class="contenedorpro">
    ...
    $loop_spa = new WP_Query($args);
    if( $loop_spa->have_posts() ):
      while( $loop_spa->have_posts() ): $loop_spa->the_post(); ?>
...
if (function_exists( 'wp_pagenavi' )) {
  //wp_pagenavi( array( 'query' => $loop_spa ) );
}
